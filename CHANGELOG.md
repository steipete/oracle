...
### Fixed
- MCP: let `consult` inherit browser defaults from `~/.oracle/config.json` while still honoring explicit tool-call overrides and preserving manual-login/cookie-sync settings. (#109) — thanks @doodaaatimmy-creator.
