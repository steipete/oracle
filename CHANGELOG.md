...
- Browser: create fallback source ZIPs only when ChatGPT rejects an inline paste, and delete generated `oracle-browser-bundle-*` directories after browser runs and dry-runs.
