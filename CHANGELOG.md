...
- Browser: combine multiple uploaded text files into one ordered, source-labelled bundle so composer readiness cannot stall on one of many equivalent text attachments; direct-upload timeouts now name missing attachments and report the final send/upload state.
