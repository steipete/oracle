...
- Depth: GPT‑5.5 Pro may appear as Pro Extended and currently exposes Standard/Extended effort in ChatGPT; use `--model gpt-5.5 --browser-thinking-time heavy` when you specifically need Thinking 5.5 Heavy.
