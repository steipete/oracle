...
| `--browser-scheduled-task`                                                     | Submit the prompt through ChatGPT's Scheduled page, verify the conversation handoff, skip model selection, and keep the source conversation.                                                                                                                                                                                              |
| `--browser-pin-conversation`                                                   | Pin the resulting ChatGPT conversation and fail if the pinned state cannot be verified.                                                                                                                                                                                                                                                   |
