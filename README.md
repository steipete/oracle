...
| `--browser-max-concurrent-tabs`                                                | Soft limit for simultaneous ChatGPT tabs sharing one manual-login profile (default 1).                                                                                                                                                                                                                                                    |
| `--browser-queue-timeout`                                                      | Maximum time to wait in the FIFO shared-profile queue; default `0` waits indefinitely without consuming the active browser timeout.                                                                                                                                                                                                       |
