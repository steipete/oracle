...
| `--browser-queue-timeout`                                                      | Maximum time to wait in the FIFO shared-profile queue (default 20m); `0` opts into an unlimited wait without consuming the active browser timeout.                                                                                                                                                                                        |
