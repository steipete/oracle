...
| `--reasoning-effort <none\|low\|medium\|high\|xhigh\|max>`                     | Override reasoning effort for GPT-5.6 API runs.                                                                                                                                                                                                                                                                                           |
| `--reasoning-mode <standard\|pro>`                                             | Select the Responses API reasoning mode for GPT-5.6 API runs. Use `--model gpt-5.6-sol --reasoning-mode pro`; Pro is not a separate model slug.                                                                                                                                                                                           |
