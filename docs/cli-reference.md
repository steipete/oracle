...
| `--browser-bundle-files`, `--browser-bundle-format <auto\|text\|zip>`          | Control browser upload bundles; multiple uploaded text files automatically share one labelled text bundle.                   |
