...
- Browser-only extras: `browserAttachments?: "auto"|"never"|"always"`, `browserBundleFiles?: boolean`, `browserThinkingEffort?: "standard"|"extended"`, `browserKeepBrowser?: boolean`, `browserKeepTabs?: boolean`, `browserModelLabel?: string`.
