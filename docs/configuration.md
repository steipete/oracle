...
```json5
{
  ...
  browser: {
    ...
    maxConcurrentTabs: 3, // shared-profile tab limit (or set ORACLE_BROWSER_MAX_CONCURRENT_TABS)
    queueTimeoutMs: 1200000, // FIFO queue wait budget; 0 waits indefinitely (or set ORACLE_BROWSER_QUEUE_TIMEOUT)
